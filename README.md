...
- [Digipolis API design & style requirements v5.2.0](#digipolis-api-design--style-requirements-v520)
...
400 Bad request            | De request kan niet worden verwerkt omdat de request body niet geparsed kan worden. Wordt gebruikt indien er geen specifiekere foutboodschap bestaat binnen de 4xx range.                                                                                               | Ja, de reden van de weigering in het error model.         
